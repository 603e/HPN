...
$.extend($.fn.dialog.defaults, frm.onMove);
$.extend($.fn.window.defaults, frm.onMove);
$.extend($.fn.panel.defaults, frm.onMove);
...
$.extend($.fn.datagrid.defaults, frm.onLoadError);
$.extend($.fn.treegrid.defaults, frm.onLoadError);
$.extend($.fn.tree.defaults, frm.onLoadError);
$.extend($.fn.combogrid.defaults, frm.onLoadError);
$.extend($.fn.combobox.defaults, frm.onLoadError);
$.extend($.fn.form.defaults, frm.onLoadError);
...
$.extend($.fn.combotree.defaults, frm.loadFilter);
$.extend($.fn.tree.defaults, frm.loadFilter);
 ...
 * 
 */
frm.modalDialog = function(options) {
	var opts = $.extend({
		title : '&nbsp;',
		width : 640,
		height : 480,
 ...
 * @param themeName
 */
frm.changeTheme = function(themeName) {
	...
	frm.cookie('easyuiTheme', themeName, {
		expires : 7
	});
};
 ...
 * @requires jQuery,EasyUI
 */
frm.progressBar = function(options) {
