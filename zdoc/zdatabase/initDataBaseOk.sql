...
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('8a3ffd73-4ca9-4b4a-8535-ef0dd169d26e','2017-02-05 18:31:35','客户的CRUD','ext-icon-group','客户管理',100,NULL,'2017-02-05 18:31:35','/jsp/ifr/cr/Customer.jsp','5d9d85c4-32f0-4c58-b892-619e03ac4b6a','60366688-0001-0001-0011-8888rstype00');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('202c4ea3-454f-4df4-b50b-4394eed6978e','2017-02-05 18:36:33','根据ID查询','ext-icon-group_key','查询（ID）',101,NULL,'2017-02-05 18:36:33','/ifr/cr/customer!getById','8a3ffd73-4ca9-4b4a-8535-ef0dd169d26e','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('4e85e519-3b03-4fdc-ab2c-17d0dbc72209','2017-02-05 18:39:47','删除客户','ext-icon-group_delete','删除（逻辑）',104,NULL,'2017-02-06 21:12:35','/ifr/cr/customer!delete','8a3ffd73-4ca9-4b4a-8535-ef0dd169d26e','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('750db3a0-f034-48e4-9c72-68d9562176fe','2017-02-05 18:35:23','全部或按条件查询','ext-icon-group','查询',100,NULL,'2017-02-05 18:35:23','/ifr/cr/customer!grid','8a3ffd73-4ca9-4b4a-8535-ef0dd169d26e','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('75119f99-af52-45c2-aa56-bcbdb694b152','2017-02-05 18:38:54','增加客户信息','ext-icon-group_add','新增',102,NULL,'2017-02-05 18:38:54','/ifr/cr/customer!save','8a3ffd73-4ca9-4b4a-8535-ef0dd169d26e','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('df9a5d92-fcbb-4522-b053-f2dc73166f16','2017-02-05 18:37:42','修改客户信息','ext-icon-group_edit','修改',103,NULL,'2017-02-05 18:37:42','/ifr/cr/customer!update','8a3ffd73-4ca9-4b4a-8535-ef0dd169d26e','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('fa68f5df-3444-4599-92cd-365373f937b5','2017-02-05 18:49:25','存款的增加、需改、作废','ext-icon-coins','存款管理',100,NULL,'2017-02-05 18:49:25','/jsp/ifr/fc/Deposit.jsp','0c9c6724-a92b-4479-b7fe-b6fb0134afc9','60366688-0001-0001-0011-8888rstype00');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('5d0bdb0a-aa02-4734-9bfc-1b263aea7430','2017-02-06 21:16:44','修改存款单','ext-icon-weather_sun','修改',103,NULL,'2017-02-06 21:16:58','/ifr/fc/deposit!update','fa68f5df-3444-4599-92cd-365373f937b5','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('9d12ffcc-d6ed-49a9-91d7-d08e4cb60985','2017-02-06 21:18:25','逻辑删除存款单','ext-icon-coins_delete','删除（逻辑）',104,NULL,'2017-02-06 21:18:25','/ifr/fc/deposit!delete','fa68f5df-3444-4599-92cd-365373f937b5','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('a5f202ef-d69e-4e59-ae9d-3008d6e28ad3','2017-02-06 21:13:56','新增存款单','ext-icon-coins_add','新增',102,NULL,'2017-02-06 21:13:56','/ifr/fc/deposit!save','fa68f5df-3444-4599-92cd-365373f937b5','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('da69bb50-09e7-400d-b46d-c204df6afbf7','2017-02-18 07:02:35','打印存单','ext-icon-printer','打印',105,NULL,'2017-02-18 07:02:35','/ifr/fc/deposit!print','fa68f5df-3444-4599-92cd-365373f937b5','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('dd4ff8ec-7b45-4be3-b28d-c639f5a120c5','2017-02-06 21:09:07','按条件查询业务类型为存款的数据','ext-icon-coins','查询',100,NULL,'2017-02-06 21:09:07','/ifr/fc/deposit!grid','fa68f5df-3444-4599-92cd-365373f937b5','60366688-0001-0001-0011-8888rstype01');
insert  into `frm_resource`(`id`,`createdatetime`,`description`,`iconcls`,`NAME`,`seq`,`target`,`updatedatetime`,`url`,`resource_id`,`resourcetype_id`) values ('f4bd3e23-7313-4996-bc61-35070266053d','2017-02-06 21:12:07','按ID查询业务类型为存款的数据','ext-icon-sport_tennis','查询（ID）',101,NULL,'2017-02-06 21:12:07','/ifr/fc/deposit!getById','fa68f5df-3444-4599-92cd-365373f937b5','60366688-0001-0001-0011-8888rstype01');
